...
exports.handler = async (event) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      cancel_url: product === "care" ? `${process.env.SITE_URL || "https://sentinelprime.org"}/care` : `${process.env.SITE_URL || "https://sentinelprime.org"}/pricing`,
      metadata: { plan, product: product || "sentinelai" },
