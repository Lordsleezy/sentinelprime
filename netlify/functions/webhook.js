...
exports.handler = async (event) => {
  ...
  if (stripeEvent.type === "checkout.session.completed") {
    ...
    const code = await createCode(supabase, { type, email, stripeSubId: object.subscription, stripeCustomerId: object.customer, stripePaymentIntentId: object.payment_intent, expiresAt, notes: `Stripe checkout ${object.id}` });
